...
const Dogrulama = () => {
  ...
  const handleNewCode = (e) => {
    ...
    if (!isInitialCodeSent || remainingTime <= 0) {
          ...
          >
            {kisiDogrulandi ? (
              <>
                ...
                <motion.div
                  variants={itemVariants}
                  className="mt-5 max-w-4xl w-full flex flex-col md:flex-row gap-5"
                >
                  <label
                    htmlFor="kurumsal"
              ...
              <>
                ...
                >
                  ...
                  <form className="mt-5 space-y-4" onSubmit={handleKisiSubmit}>
                    <motion.div
                      className="py-2 px-3 md:px-5 montserrat rounded-lg border border-[#A2ACC7] flex flex-col"
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
